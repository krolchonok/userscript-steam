...
(function($, async) {
    ...
    if (currentPage == PAGE_INVENTORY) {
        ...
        function updateInventorySelection(selectedItem) {
            ...
            market.getItemOrdersHistogram(item,
                ...
                function(err, histogram) {
                    ...
                    ownerActions.append('<a class="btn_small btn_grey_white_innerfade" href="/market/listings/' + appid + '/' + market_hash_name + '"><span>Посмотреть на торговой площадке</span></a>');
        ...
        function updateInventoryUI(isOwnInventory) {
            ...
            var sellButtons = $('<div id="inventory_sell_buttons" style="margin-bottom:12px;">' +
                '<a class="btn_green_white_innerfade btn_medium_wide sell_all separator-btn-right"><span>Продать все</span></a>' +
                '<a class="btn_green_white_innerfade btn_medium_wide sell_all_duplicates separator-btn-right"><span>Продать все повторы</span></a>' +
                '<a class="btn_green_white_innerfade btn_medium_wide sell_selected separator-btn-right" style="display:none"><span>Продать выбранные предметы</span></a>' +
                '<a class="btn_green_white_innerfade btn_medium_wide sell_manual separator-btn-right" style="display:none"><span>Продать вручную</span></a>' +
                (showMiscOptions ?
    ...
    injectCss('.ui-selected { outline: 2px dashed #FFFFFF; } ' +
        ...
        '.inventory_item_price { top: 0px;position: absolute;right: 0; padding-top: 0.5px; padding-bottom: 0.5px; background: #292929; color: white; font-size:11px; width: 100%; text-align: center; }' +
